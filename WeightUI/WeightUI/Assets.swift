...
public enum Asset {
  public enum Colours {
    public static let deepPurple100 = ColorAsset(name: "Deep Purple 100")
    public static let deepPurple400 = ColorAsset(name: "Deep Purple 400")
    public static let deepPurple700 = ColorAsset(name: "Deep Purple 700")
    public static let deepPurple800 = ColorAsset(name: "Deep Purple 800")
    public static let deepPurple900 = ColorAsset(name: "Deep Purple 900")
  }
  public enum Icons {
  }
}
